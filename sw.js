const CACHE='fv-training-os-4.0.0-rc1';
const SHELL=['./','./index.html','./styles.css','./app.mjs','./engine.mjs','./program.mjs','./manifest.webmanifest','./icon-192.png','./icon-512.png','./apple-touch-icon.png'];
